...
- #tool:read/problems to check compile errors
- #tool:search to find the source of the issue
- #tool:execute/testFailure to analyze test failures
- #tool:execute/runInTerminal to run diagnostic commands
