...
if [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/midnightntwrk/compact/releases/download/compact-v0.3.0"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.28.6"},"source":{"app_name":"compact","name":"compact","owner":"midnightntwrk","release_type":"github"},"version":"0.3.0"}
EORECEIPT
...
The installer for compact 0.3.0

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/midnightntwrk/compact/releases/download/compact-v0.3.0
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "compact-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="9d2ef8f37d2629486985709afaaf5a68e32c005b3f18af38415e1a6f2b6ccaeb"
            _bins="compact"
        ...
        "compact-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="79682f59f4465410b08b1df45842e7f5d39a6579485df179a17a8b4459c44ca1"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
        ...
        "compact-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="b3dc7fa4c7c52cb5e2ed5f29a461dd910ef4cd2bb8981d203dcb6b07d64e4f9c"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
